...
env.path = '/host/Users/shane/Documents/dev/python/adrGeoCode/JoeGermuska-hello_newsroom-dad2f02/%(project_name)s' % env
env.log_path = '/host/Users/shane/Documents/dev/python/adrGeoCode/JoeGermuska-hello_newsroom-dad2f02/logs/%(project_name)s' % env
...
def create_database(func=run):
    ...
    func('createdb -O %(project_name)s %(project_name)s -T template_postgis_two' % env)
